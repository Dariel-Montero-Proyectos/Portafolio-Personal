<template>
  <main
    ...
    <div class="space-y-2 text-center md:text-left px-10">
      ...
      <p class="text-white pr-4 fade-in-from-left">Bienvenido a mi sitio web personal. <span class="wave">👋🏼</span></p>
      <br>
...
export default {
  ...
  data() {
    return {
      toRotate: ["Desarrollador Full-Stack", "Estudiante de Ingeniería", "Apasionado de la tecnología"],
      period: 2000,
      txt: '',
      loopNum: 0,
      isDeleting: false,
